...
class CustomTestRunner(BaseRunner):
    ...
    def setup_databases(self, *args, **kwargs):
        ...
        self.consonant_type = PhonemeType.objects.create(id=1,
                                                         type_name="Consonnes")
        self.vowel_type = PhonemeType.objects.create(id=2,
                                                     type_name="Voyelles")

        self.diphthong_subtype = SubPhonemeType.objects.create \
            (id=11
             , subtype_name="Diphtongues"
             , phoneme_type_id=PhonemeType.objects.get(
                id=self.vowel_type.id).id)
        self.simple_vowel_subtype = SubPhonemeType.objects.create(id=6
        ...
        self.phoneme1 = PhonemeInformation.objects.create(id=1
            ...
            (id=self.diphthong_subtype.id).id)
        ...
        self.phoneme3 = PhonemeInformation.objects.create(id=3
                                                          ...
                                                          , sub_phoneme_type_id=SubPhonemeType.objects.get
            (id=self.consonants_subtype.id).id)
